...
export const MOCK_TRIBES: TribeResponse[] = [
  ...
  },
  {
    ...
    nameEn: "Multi-Ong",
    color: "blue",
    description: "หลายไทป์ในใจเดียว เปิดใจทุกความสนใจ",
    memberCount: 3389,
  },
];

export const MOCK_INTERESTS: InterestResponse[] = [
  { id: "i-anime-jump", tribeId: "t-cartoon", name: "Shonen" },
  { id: "i-anime-slice", tribeId: "t-cartoon", name: "Slice of Life" },
  { id: "i-anime-ghibli", tribeId: "t-cartoon", name: "Studio Ghibli" },
  { id: "i-mountain-doi", tribeId: "t-mountain", name: "ปีนดอย" },
  { id: "i-mountain-camp", tribeId: "t-mountain", name: "เดินป่า/แคมป์" },
  { id: "i-mountain-sunrise", tribeId: "t-mountain", name: "ดูพระอาทิตย์ขึ้น" },
  { id: "i-cactus-succ", tribeId: "t-cactus", name: "Succulent" },
  { id: "i-cactus-rare", tribeId: "t-cactus", name: "พันธุ์หายาก" },
  { id: "i-dog-shiba", tribeId: "t-dog", name: "ชิบาอินุ" },
  { id: "i-dog-golden", tribeId: "t-dog", name: "โกลเด้น" },
  { id: "i-dog-adopt", tribeId: "t-dog", name: "รับเลี้ยง" },
  { id: "i-exotic-reptile", tribeId: "t-exotic", name: "สัตว์เลื้อยคลาน" },
  { id: "i-exotic-amphib", tribeId: "t-exotic", name: "สัตว์สะเทิน" },
];

const ME: UserResponse = {
  id: "u-me",
  displayName: "คุณ",
  bio: "กำลังหาคนไทป์เดียวกัน",
  age: 26,
...
const MOCK_OTHERS: UserResponse[] = [
  ...
  },
  {
    id: "u-5",
    displayName: "เบนซ์",
    bio: "เลี้ยงสัตว์เอ็กโซติกที่บ้าน งู กิ้งก่า มีหมด",
    age: 29,
    location: "กรุงเทพมหานคร",
    avatarUrl: "",
...
export const MOCK_CHAT_ROOMS: ChatRoomResponse[] = [
  ...
  },
  {
    ...
    name: "เอิร์น",
    avatarUrl: "",
    lastMessage: "อ๊อก! ตรงไทป์กันจริง",
  ...
  "r-cactus": [
    {
      ...
      senderId: "u-1",
      senderName: "เอิร์น",
      content: "สวัสดีค่าชาวไทป์กระบองเพชร",
  ...
  "r-u1": [
    {
      ...
      senderId: "u-1",
      senderName: "เอิร์น",
      content: "เห็นโปรไฟล์แล้ว เราไทป์เดียวกันเลยนะ",
    ...
    },
    {
      ...
      senderId: "u-me",
      senderName: "คุณ",
      content: "จริงดิ! 92% เลย อ๊อก! ตรงไทป์กัน",
